...
public class MaterialQuestion implements IBasePO<String> {
    /**
     * 教材题目id
     */
    private String id;
    ...
    public MaterialQuestion() {

    }

    public MaterialQuestion(String id, String masterId, String questId, Integer questOrder, Integer rank) {
        this.id = id;
